...
public class WebTestBase {
    ...
    public void setUpBrowser(boolean useCloudEnv, String envName, String os, String osVersion, String browserName, String browserVersion, String url) {
    ...
    public void driverSetUp(String envURL) {
        driver.get(envURL);
...
//            chromeOptions.addArguments("--headless=new");
    ...
    public void getCloudDriver(String envName, String os, String osVersion, String browserName, String browserVersion) {
